...
[`DynQuantity`]: https://docs.rs/dyn_quantity/0.5.6/dyn_quantity/quantity/struct.DynQuantity.html
[`Unit`]: https://docs.rs/dyn_quantity/0.5.6/dyn_quantity/unit/struct.Unit.html
[`Quantity`]: https://docs.rs/uom/latest/uom/si/struct.Quantity.html
[`deserialize_with`]: https://docs.rs/dyn_quantity/0.5.6/dyn_quantity/deserialize_with/index.html
...
The full API documentation is available at [https://docs.rs/dyn_quantity/0.5.6/dyn_quantity/](https://docs.rs/dyn_quantity/0.5.6/dyn_quantity/).